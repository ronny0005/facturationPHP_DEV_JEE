                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    ...
                    <ul class="nav navbar-nav">
                        <li class="nav-item dropdown"><a class="dropdown-toggle nav-link active" data-toggle="dropdown" aria-expanded="false" href="#">Structure</a>
                            <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="listeArticlecr">Article</a><a class="dropdown-item" role="presentation" href="#">Client</a><a class="dropdown-item" role="presentation" href="#">Fournisseur</a><a class="dropdown-item"
