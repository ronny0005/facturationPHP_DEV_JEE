        ...
        <ul class="nav navbar-nav">
            <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#" style="color: rgb(2,78,5);font-weight: bold;">Etats</a>
                <div class="dropdown-menu" role="menu">
                    ...
                    <a class="dropdown-item" role="presentation" href="#">Ctrle report fond de caisse</a>
                    <a class="dropdown-item" role="presentation" href="#">Balance des tiers</a>
                    <a class="dropdown-item" role="presentation" href="#">Ech tiers</a>
                    <a class="dropdown-item" role="presentation" href="#">Etat de réaprovisionnement</a>
                    <a class="dropdown-item" role="presentation" href="#">Etat d'exploitation</a>
                    <a class="dropdown-item" role="presentation" href="#">Transfert de caisse</a>
                    <a class="dropdown-item" role="presentation" href="#">Stock grand depot</a>
                    <a class="dropdown-item" role="presentation" href="#">Etat compte résultat</a>
                    <a class="dropdown-item" role="presentation" href="#">Fichier central rap</a>
                    <a class="dropdown-item" role="presentation" href="#">Ecriture comptable</a>
                    <a class="dropdown-item" role="presentation" href="#">Grand livre tiers commercial</a>
            ...
            <li class="nav-item dropdown no-arrow mx-1" role="presentation">
                <form class="form-inline d-none d-sm-inline-block mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                    <div class="input-group"><input class="bg-light form-control border-0 small" type="text" placeholder="Search for ...">
                        <div class="input-group-append"><button class="btn btn-primary py-0" type="button" style="background-color: rgb(2,78,5);"><i class="fas fa-search"></i></button></div>
                    </div>
                </form>
            </li>
        </ul>
