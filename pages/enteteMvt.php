...
<legend class="entete">Entete</legend>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            ...
            <input class="form-control" type="hidden" name="CO_No" id="CO_No" value="<?= ($type=="Transfert" || $type=="Transfert_confirmation") ? $docEntete->DO_Tiers : $docEntete->DE_No ?>" <?php if(isset($_GET["cbMarq"]) || $isVisu) echo "disabled"; ?> />
            <input class="form-control" type="text" name="collaborateur" id="collaborateur" value="<?= ($type=="Transfert" || $type=="Transfert_confirmation") ? (new DepotClass($docEntete->DO_Tiers,$objet->db))->DE_Intitule : (new DepotClass($docEntete->DE_No,$objet->db))->DE_Intitule ?>" <?php if(isset($_GET["cbMarq"]) || $isVisu) echo "disabled"; ?> />
            </div>
        <?php
        }
