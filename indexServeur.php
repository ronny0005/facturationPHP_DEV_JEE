...
switch ($val) {
    ...
    case "listeReglementCaisseFormat":
        ...
        foreach($list as $element) {
            ...
            $itemTable = $itemTable."<tr class= 'reglement $classe' id='reglement_".$element->RG_No." '>"
                ."<td style='color:blue;text-decoration:underline' id='RG_No'>".$element->RG_No."</td><td id='RG_Piece'>". $element->RG_Piece ."</td><td id='RG_Date'>" .$element->RG_Date."</td>"
                ."<td id='RG_Libelle'>".$element->RG_Libelle. "</td><td id='RG_Montant'>" .$objet->formatChiffre($RG_Montant) ."</td>"
                ."<td id='CA_Intitule'>" . $element->CA_Intitule ."</td><td id='CO_Nom'><span id='RG_No' style='visibility:hidden'>" .$element->RG_No ."</span>" .$element->CO_Nom
                ."</td><td id='RG_TypeReg'>" . typeCaisse($element->RG_TypeReg) . "</td>" ;//+ blocAffaire;
        ...
        $itemTable =$itemTable ."<tr class='reglement' style='background-color:grey;color:white'><td id='rgltTotal'><b>Total</b></td><td></td><td></td><td></td><td><b>".$objet->formatChiffre($sommeTotal)."</b></td><td></td><td></td><td></td><td></td><td></td></tr>";
        echo $itemTable ;
        break;
